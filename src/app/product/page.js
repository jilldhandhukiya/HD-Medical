...
export default function ProductHero() {
  ...
  const scrollToAdvantages = () => {
    advantagesRef.current?.scrollIntoView({ behavior: 'smooth', block: 'start' });
  };
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
            ...
            <div className="bg-white rounded-2xl p-4 sm:p-5 shadow-sm border border-gray-100">
              ...
              <p className="text-sm md:text-base text-gray-600 leading-relaxed mt-2 ml-16">
                Enables evidence‑based care to build patient trust and improve retention through objective data.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-4 sm:p-5 shadow-sm border border-gray-100">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-full flex items-center justify-center overflow-hidden" style={{ backgroundColor: PRIMARY_BLUE }}>
                  <Image src="/icons/product/save-lives-w.png" alt="Optimize Care Delivery" width={40} height={40} className="object-contain" />
                </div>
                <div className="flex-1">
                  <h4 className="text-lg md:text-xl font-semibold text-gray-900">Optimize Care Delivery</h4>
                </div>
              </div>
      ...
      {/* NEW: HD Steth Bluetooth App — enhanced, larger, more attractive */}
      <section className="w-full py-24 md:py-32 px-6 md:px-12 lg:px-20 bg-gradient-to-b from-white via-slate-50 to-slate-100">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Left: Headings + bullets + CTA */}
            <div className="text-center lg:text-left">
              <span className="inline-block px-4 py-2 rounded-full text-sm font-semibold text-[#FA6404] bg-[#FA6404]/10 mb-6">HD Steth Bluetooth enabled APP</span>

              <h3 className="text-xl md:text-2xl font-semibold text-gray-600 mb-2">SEE WHAT YOU HEAR</h3>
              <h2 className="text-4xl md:text-6xl font-extrabold leading-tight mb-6" style={{ color: PRIMARY_BLUE }}>
                SEE WHAT YOU COULD NOT HEAR
              </h2>

              <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto lg:mx-0 mb-8">
                HD Steth uses a custom app for smartphones and tablets. It connects via Bluetooth and displays heart‑sound waveforms alongside single‑lead ECG — giving clinicians both audio and visual evidence.
              </p>

              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg max-w-2xl mx-auto lg:mx-0">
                <ul className="space-y-4 text-gray-700">
                  <li className="flex items-start gap-3">
                    <span className="mt-1 inline-flex items-center justify-center w-8 h-8 rounded-full text-white" style={{ backgroundColor: PRIMARY_BLUE }}>
                      <Check className="w-4 h-4" />
                    </span>
                    <span className="text-sm md:text-base">HD Steth App complements and mirrors most functionality of the device.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="mt-1 inline-flex items-center justify-center w-8 h-8 rounded-full text-white" style={{ backgroundColor: PRIMARY_BLUE }}>
                      <Check className="w-4 h-4" />
                    </span>
                    <span className="text-sm md:text-base">Superior audio captures feeble heart sounds and surfaces them visually for review.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="mt-1 inline-flex items-center justify-center w-8 h-8 rounded-full text-white" style={{ backgroundColor: PRIMARY_BLUE }}>
                      <Check className="w-4 h-4" />
                    </span>
                    <span className="text-sm md:text-base">HS and ECG waveforms shown together provide validation and speed clinical decision‑making.</span>
                  </li>
                </ul>

                <div className="mt-6 flex justify-center lg:justify-start">
                  <button className="inline-flex items-center gap-3 px-6 py-3 rounded-full font-bold text-white shadow-xl transform hover:scale-105 transition"
            ...
            {/* Right: Large centered app image in device mockup */}
            <div className="flex items-center justify-center">
              <div className="relative w-full max-w-[520px]">
                {/* Phone/frame */}
                <div className="mx-auto rounded-3xl bg-gradient-to-br from-white to-slate-50 shadow-2xl p-6" style={{ border: `1px solid rgba(16,21,133,0.06)` }}>
                  ...
                  <div className="mt-4 flex justify-between items-center text-sm text-gray-500">
                    ...
                    <div className="text-right">
                      <div className="text-xs">Bluetooth • Real‑time</div>
                      <div className="text-xs">Save • Share • Export</div>
                    </div>
                  </div>
                </div>

                {/* Decorative accent */}
                <div className="pointer-events-none absolute -right-8 -bottom-8 w-40 h-40 rounded-full bg-gradient-to-tr from-[#101585]/10 to-[#FA6404]/8 blur-2xl"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="w-full py-16 px-6 md:px-12 lg:px-20 bg-gradient-to-b from-white to-slate-50">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
          <span className="inline-block px-4 py-2 rounded-full text-sm font-semibold text-[#FA6404] bg-[#FA6404]/10 mb-4">Features of HD Steth App</span>
          <h3 className="text-2xl md:text-3xl font-extrabold mb-6" style={{ color: PRIMARY_BLUE }}>Features of HD Steth App</h3>
          <p className="text-gray-600 max-w-2xl mb-8">Designed for clinicians — visual, shareable and wireless. Key app capabilities:</p>
